...
<div class="container" style="background-color: white;">
    ...
    <div id="content">
        <form class="form-horizontal" method="POST" enctype="multipart/form-data"  action="{{route('suathanhvien',$thanhvien->id)}}">
                            {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" name="email" class="form-control" id="email" value="{!! $thanhvien->email !!}" placeholder="Nhập email" >
                                        @if($errors->has('email'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="user_type" class="form-control" id="user_type" value="{!! $thanhvien->user_type !!}" placeholder="Nhập 1 nếu người quản lý" >
                                        @if($errors->has('user_type'))
                                            <label style="color: red">{{$errors->first('user_type')}}</label>
                                        @endif
                                    </div>
                                </div>
