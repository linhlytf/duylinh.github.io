                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="{{route('chitietsanpham',$sptl->id)}}"><img src="source/image/product/{{ $sptl->image }}"
                                            height="250px" alt="{{ $sptl->name }}"></a>
                                        </div>
                                        ...
                                        <div class="single-item-caption">
                                            <a class="add-to-cart pull-left" href="shopping_cart.html"><i
                                                ...
                                                <a class="beta-btn primary" href="{{route('chitietsanpham',$sptl->id)}}">Chi tiết <i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="single-item">
                                                ...
                                                @endif
                                                <div class="single-item-header">
                                                    <a href="{{route('chitietsanpham',$spk->id)}}"><img src="source/image/product/{{ $spk->image }}"
                                                        height="250px" alt="{{ $spk->name }}"></a>
                                                    </div>
                                                    <div class="single-item-body">
